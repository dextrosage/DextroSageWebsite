...
import { Shield, Mail, Phone, Trash2, LogOut, Key, ShieldAlert } from 'lucide-react';
...
export const SuperAdminProfile: React.FC = () => {
  ...
  // Fetch active sessions for the current super admin
  ...
  const handleDeleteAllConfirm = async () => {
    ...
    try {
      ...
      showSuccess('All active sessions revoked. Signing out...', 'Sessions Purged');
  ...
  const handleDeleteAccountConfirm = async () => {
    ...
    try {
      ...
      showSuccess('Your super admin account has been deleted.', 'Account Deleted');
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        <h2 className="text-xl font-bold text-white tracking-[0.1em] uppercase">Super Admin Profile</h2>
        <p className="text-xs text-gray-400 mt-1">
          Review your super administrator details and manage active login sessions.
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Columns: info & active sessions */}
            ...
            <CardHeader className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xxs text-gray-400">Super Admin Account</p>
                </div>
              </div>
              <Button
                variant="primary"
          ...
          <Card>
            <CardHeader className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white tracking-wide uppercase">Active Sessions</h3>
        ...
        {/* Right Column: JWT Token Diagnostics */}
        <div className="lg:col-span-1">
          <Card className="h-full">
            <CardHeader className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-white tracking-wide uppercase">JWT Token Info</h3>
                <p className="text-xxs text-gray-400">Diagnostic Details</p>
              </div>
            </CardHeader>
      ...
      >
        <p className="text-sm text-gray-400">
          ...
          This includes your current session, and you will be signed out immediately.
        </p>
      </Modal>
      ...
      <Modal
        ...
        title="Delete Your Super Admin Account?"
      ...
      >
        <p className="text-sm text-gray-400">
          Are you sure you want to permanently delete your <strong className="text-white">Super Admin</strong> account?
